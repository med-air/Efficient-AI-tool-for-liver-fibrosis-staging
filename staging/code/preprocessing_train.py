...
for dir, file, images in os.walk(train_file_path):
    if 'gt.nii' in images:
        ...
        saved_path = '../../data/data_npy_cls/'  + saved_name+'.npy.h5' 
        saved_path = Path(saved_path).as_posix()
